...
const SlideContainer: React.FC<Props> = ({children,initialOffsetX,className,contentWidth}) => {
...
export const SliderItem: React.FC<ItemProps> = ({children,width}) => (
    <div className="inline-flex justify-center items-center mx-4" style={{width:width}}>{children}</div>
)
