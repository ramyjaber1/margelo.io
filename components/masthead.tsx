  ...
  return (
    ...
    >
      <video autoPlay loop muted playsInline className="absolute w-full h-full object-cover">
          <source src={"https://margelo.io/assets/masthead-bg.mp4"} type="video/mov;" />
      </video>
      ...
      <div className="p-12 font-bold z-10 text-white drop-shadow-[0_5px_4px_rgba(0,0,0,0.4)] text-center flex-1 flex items-center justify-center flex-col">
      ...
      <div className={`flex-grow-0 pb-20 md:pb-10 transition-all duration-1000 ${imageLoaded ? 'opacity-100' : 'opacity-0 -translate-y-10' }`}>
          <Image src={"https://margelo.io/assets/arrow-down.png"} width={188/3} height={105/3} alt="scroll down" onLoadingComplete={handleImageLoaded} />
      </div>
    </div>
  );
};
